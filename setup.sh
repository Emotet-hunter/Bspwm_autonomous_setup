...
#Download Wallpaper
curl \
  -H 'Authorization: token $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' \
  -H 'Accept: application/vnd.github.v3.raw' \
  -O \
  -L 'https://github.com/Emotet-hunter/Bspwn_autonomus_setup/raw/main/wallpaper.jpg'
